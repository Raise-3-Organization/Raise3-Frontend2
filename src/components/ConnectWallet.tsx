...
const ConnectWallet: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between bg-black text-white px-6 min-h-screen overflow-y-auto py-10">
      ...
      {/* Main Content - with flex layout to push terms to bottom */}
      ...
      {/* Terms and Support - fixed at bottom */}
      <div className="text-center text-sm space-y-2 w-full max-w-md bg-[#111] p-4 rounded-lg mt-auto">
      ...
      {/* Bottom gradient for visual effect only */}
