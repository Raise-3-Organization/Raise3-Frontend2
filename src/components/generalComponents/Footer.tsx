    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Raise3</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              The decentralized platform connecting founders and investors.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/waitlist" className="text-gray-600 hover:text-primary dark:text-gray-400">
                  Join Waitlist
                </Link>
              </li>
              <li>
                <Link href="/dashboard" className="text-gray-600 hover:text-primary dark:text-gray-400">
                  Dashboard
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
          <p className="text-sm text-center text-gray-600 dark:text-gray-400">
            © {new Date().getFullYear()} Raise3. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
